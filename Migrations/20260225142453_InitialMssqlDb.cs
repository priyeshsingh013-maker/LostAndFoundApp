...
{
    /// <inheritdoc />
    public partial class InitialMssqlDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SamAccountName = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FoundByNames", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationFound = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    ...
                    FoundById = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LostFoundItems", x => x.TrackingId);
                    table.ForeignKey(
                        name: "FK_LostFoundItems_FoundByNames_FoundById",
                        column: x => x.FoundById,
                        principalTable: "FoundByNames",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_LostFoundItems_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LostFoundItems_Routes_RouteId",
                        column: x => x.RouteId,
                        principalTable: "Routes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_LostFoundItems_Statuses_StatusId",
                        column: x => x.StatusId,
                        principalTable: "Statuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LostFoundItems_StorageLocations_StorageLocationId",
                        column: x => x.StorageLocationId,
                        principalTable: "StorageLocations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_LostFoundItems_Vehicles_VehicleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LostFoundItems_DateFound",
                table: "LostFoundItems",
                column: "DateFound");

            migrationBuilder.CreateIndex(
                name: "IX_LostFoundItems_FoundById",
                table: "LostFoundItems",
                column: "FoundById");

            migrationBuilder.CreateIndex(
                name: "IX_LostFoundItems_ItemId",
                table: "LostFoundItems",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_LostFoundItems_RouteId",
                table: "LostFoundItems",
                column: "RouteId");

            migrationBuilder.CreateIndex(
                name: "IX_LostFoundItems_StatusId",
                table: "LostFoundItems",
                column: "StatusId");

            migrationBuilder.CreateIndex(
                name: "IX_LostFoundItems_StorageLocationId",
                table: "LostFoundItems",
                column: "StorageLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_LostFoundItems_VehicleId",
                table: "LostFoundItems",
                column: "VehicleId");
